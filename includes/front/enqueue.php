...
function u_enqueue()
{
	...
	wp_register_style('u_bootstrap_icons', get_theme_file_uri('assets/theme/bootstrap-icons/bootstrap-icons.css'));
	wp_register_style('u_theme', get_theme_file_uri('assets/theme/public/index.css'));
